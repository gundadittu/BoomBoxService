...
export const setLinkedStreamingAccountForUser = functions.https.onCall(async (data, context) => {
    ...
    if (type == "appleMusic") {
        ...
        // TODO: modify below function to return IsrcStoreItems for existing songs 
        ...
        // TODO: extract existing IsrcStoreItems items instead 
        ...
        // TODO: create function that creates isrcstore items for missing songs 
        ...
        // TODO: stores users library songs + isrc items in db
